...
// Lazy-initialize storage client to prevent startup crashes
...
export class ObjectStorageService {
  ...
  async getObjectEntityUploadURL(filename?: string): Promise<{ uploadURL: string; objectPath: string }> {
    ...
    const fullPath = `${privateObjectDir}/course-images/${objectName}`;
    ...
    return { 
      uploadURL, 
      objectPath: `/objects/course-images/${objectName}` 
    };
  }
