...
export interface IStorage {
  ...
  getAffiliateEmailCourses(): Promise<Array<GolfCourse & { lastAffiliateSentAt: Date | null; emailCount: number; onboardingStage: string | null; totalOpens: number; lastOpenedAt: Date | null; outreachResendCount: number }>>;
  ...
  updateUser(id: string, updates: { firstName?: string; lastName?: string; email?: string; phoneNumber?: string; isAdmin?: string; country?: string; handicap?: number | null; homeClub?: string; preferredTeeTime?: string; gender?: string; savedPlayersJson?: string }): Promise<User | undefined>;
...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    const seedCourses: InsertGolfCourse[] = [
      ...
      // NEW COURSES - Added from Brian Nielsen comparison
      {
        ...
        lat: "36.7145",
        lng: "-4.2850",
        websiteUrl: "https://www.anoretaresort.com",
        bookingUrl: "https://open.teeone.golf/en/anoreta/disponibilidad",
        email: "golf@anoretaresort.com",
        phone: "+34 952 40 50 00",
        notes: "José María Cañizares design - 18 holes par 72, 5 lakes affecting 11 holes",
        imageUrl: "/generated_images/añoreta_golf_spain_course.png",
        facilities: ["Clubhouse", "Pro Shop", "Driving Range", "Restaurant", "Bar", "Putting Green", "Cart Rental", "Locker Rooms", "Practice Facilities", "Golf Academy"],
      },
      {
        ...
        lat: "36.4925",
        lng: "-4.7450",
        websiteUrl: "https://www.cabopinogolfmarbella.com",
        bookingUrl: "https://open.teeone.golf/en/cabopino/disponibilidad",
        email: "info@cabopinogolfmarbella.com",
        phone: "+34 951 60 70 04",
        notes: "18 holes par 71 - Short tight layout, dramatic elevation, Mediterranean views",
        imageUrl: "/generated_images/cabopino_golf_marbella_course.png",
        facilities: ["Clubhouse", "Pro Shop", "Driving Range", "Restaurant", "Bar", "Putting Green", "Cart Rental", "Locker Rooms", "Practice Facilities", "Golf Academy"],
      },
      {
        name: "La Zagaleta Golf Club",
        city: "Benahavís",
        province: "Málaga",
        country: "Spain",
        lat: "36.5120",
        lng: "-5.0150",
        websiteUrl: "https://www.clubdecampolazagaleta.com",
        bookingUrl: "https://www.clubdecampolazagaleta.com",
        email: "info@clubdecampolazagaleta.com",
        phone: "+34 952 85 54 53",
        notes: "Exclusive members-only - 2 courses: Old Course (par 72) + Los Barrancos (par 70)",
        imageUrl: "/generated_images/zagaleta_golf_exclusive_course.png",
        facilities: ["Clubhouse", "Pro Shop", "Driving Range", "Restaurant", "Bar", "Putting Green", "Cart Rental", "Locker Rooms", "Practice Facilities", "Equestrian Center", "Heliport"],
      },
      {
        name: "Villa Padierna - Alferini",
        city: "Benahavís",
        province: "Málaga",
        country: "Spain",
        lat: "36.4915",
        lng: "-4.9870",
        websiteUrl: "https://www.villapadierna.es/en/alferini/",
        bookingUrl: "https://open.imaster.golf/en/villapadierna/disponibilidad",
        email: "golf@villapadierna.es",
        phone: "+34 952 889 157",
        notes: "Championship 18 holes par 73, 6,641m - Longest and most challenging of Villa Padierna's courses",
        imageUrl: "/generated_images/villa_padierna_alferini_course.png",
        facilities: ["Clubhouse", "Pro Shop", "Driving Range", "Restaurant", "Bar", "Putting Green", "Cart Rental", "Locker Rooms", "Practice Facilities", "Golf Academy", "Spa"],
      },
      {
        name: "Villa Padierna - Tramores",
        city: "Benahavís",
        province: "Málaga",
        country: "Spain",
        lat: "36.4910",
        lng: "-4.9865",
        websiteUrl: "https://www.villapadierna.es/en/tramores/",
        bookingUrl: "https://open.imaster.golf/en/villapadierna/disponibilidad",
        email: "golf@villapadierna.es",
        phone: "+34 669 87 99 61",
        notes: "Executive 18 holes par 63, 3,468m - Fast and fun, short game focus, Michael Campbell Academy",
        imageUrl: "/generated_images/villa_padierna_tramores_course.png",
        facilities: ["Clubhouse", "Pro Shop", "Driving Range", "Restaurant", "Bar", "Putting Green", "Cart Rental", "Locker Rooms", "Practice Facilities", "Golf Academy"],
      },
    ];
    ...
    const seedTestimonials: InsertTestimonial[] = [
      {
        ...
        content: "Outstanding service from start to finish. Marbella Golf Times secured us tee times at Valderrama during peak season - something we couldn't achieve on our own. The concierge approach makes all the difference.",
        rating: 5,
        location: "London, UK",
      },
      {
        ...
        content: "We used Marbella Golf Times for our annual golf trip to Costa del Sol. The platform showed real availability across all the premium courses, and booking was seamless. Highly recommend for serious golfers.",
        rating: 5,
      ...
      },
      {
        ...
        content: "As a local, I've tried many booking platforms. Marbella Golf Times stands out for their curated selection and genuine expertise. Perfect for visitors who want the best Costa del Sol has to offer.",
        rating: 5,
      ...
      },
      {
        ...
        content: "First-class service. The platform is modern and efficient, but it's the personal touch that sets Marbella Golf Times apart. They helped us secure dream tee times at courses we'd only read about.",
        rating: 5,
  ...
  async getAffiliateEmailCourses(): Promise<Array<GolfCourse & { lastAffiliateSentAt: Date | null; emailCount: number; onboardingStage: string | null; totalOpens: number; lastOpenedAt: Date | null; outreachResendCount: number }>> {
  ...
  async updateUser(id: string, updates: { firstName?: string; lastName?: string; email?: string; phoneNumber?: string; isAdmin?: string; country?: string; handicap?: number | null; homeClub?: string; preferredTeeTime?: string; gender?: string; savedPlayersJson?: string }): Promise<User | undefined> {
    const user = this.users.get(id);
    if (!user) return undefined;
  ...
  async getAffiliateEmailCourses(): Promise<Array<GolfCourse & { lastAffiliateSentAt: Date | null; emailCount: number; onboardingStage: string | null; totalOpens: number; lastOpenedAt: Date | null; outreachResendCount: number }>> {
    const results = await db
      .select({
        ...
        outreachResendCount: courseOnboarding.outreachResendCount,
      })
      .from(golfCourses)
      ...
      .groupBy(golfCourses.id, courseOnboarding.stage, courseOnboarding.outreachResendCount);
    ...
    return results.map(r => ({
      ...
      outreachResendCount: r.outreachResendCount || 0,
    }));
  }
